...
<html>
	...
	<title>RESTAURANT&mdash;CONTACT</title>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">お問い合わせ</span>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3>店舗情報</h3>
							...
							<a href="images/sample.jpg" class="fh5co-card-item image-popup">
								<figure>
									<div class="overlay"><i class="ti-plus"></i></div>
									<img src="images/sample.jpg" alt="Image" class="img-responsive">
								</figure>
