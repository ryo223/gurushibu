...
<html>
	...
	<title>RESTAURANT&mdash;MENU</title>
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					...
					<div class="row row-mt-15em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">メニュー</span>
							<h1 class="cursive-font">Menu Page !</h1>
						</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">人気 / おすすめ</h2>
					<p>ここに写真を適度に入れる。とりあえず6枚</p>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_1.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2>パスタランチ</h2>
							<p>本日のスープ ３種のパスタ</p>
							<p><span class="price cursive-font">￥1,000</span></p>
						</div>
					</a>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-6">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_4.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2>新じゃがのオムレツ/泉州水ナスとパルメザンチーズ</h2>
							<p>たまご</p>
							<p><span class="price cursive-font">￥750</span></p>
						</div>
					</a>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_5.jpg" class="fh5co-card-item image-popup">
						...
						<div class="fh5co-text">
							<h2>三元豚ロースの回転ロースト</h2>
							<p>三元豚</p>
							<p><span class="price cursive-font">￥1500</span></p>
						</div>
					</a>
				</div>
